  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
	...
	<div id="container">
		...
		<div class="card border-info mb-3" style="max-width: 50rem;">
			  <div class="card-header">Idea Title : ${idea.name}</div>
			  <div class="card-body text-info">Author: ${idea.user.firstName}  ${idea.user.lastName}
			    <p class="card-text">
			    				
					<p>Total likes <c:out value="${idea.joinedUsers.size()}"/></p>
					
					<table class="table table-striped table-bordered table-hover">
						<thead>
			  				<tr>
			    				<th scope="col">People who liked ${idea.user.firstName}'s idea</th>
